...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_slick_carousel_slick_slick_min__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../node_modules/slick-carousel/slick/slick.min */ "./node_modules/slick-carousel/slick/slick.min.js");
/* harmony import */ var _node_modules_slick_carousel_slick_slick_min__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_slick_carousel_slick_slick_min__WEBPACK_IMPORTED_MODULE_0__);
...
/***/ "./src/js/components/summaryScroll.js":
/*!********************************************!*\
  !*** ./src/js/components/summaryScroll.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const Component_SummaryScroll = () => {
  ...
  function initSummaryScroll() {
    const summaryElement = document.querySelector(".dbw-custom-product-container .summary");
    if (!summaryElement) {
    ...
    function handleWheel(e) {
      ...
      if (mouseOverSummary) {
        ...
        if (summaryElement.scrollHeight > summaryElement.clientHeight) {
          ...
          const maxScrollTop = summaryElement.scrollHeight - summaryElement.clientHeight;
          ...
          if (deltaY < 0 && canScrollUp) {
            summaryElement.scrollTop = Math.max(0, summaryElement.scrollTop + scrollAmount);
          }
          // Scrolling nach unten (positives deltaY)
          else if (deltaY > 0 && canScrollDown) {
            summaryElement.scrollTop = Math.min(maxScrollTop, summaryElement.scrollTop + scrollAmount);
          }
        }
      }
    }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Component_SummaryScroll);
...
/* harmony import */ var _components_summaryScroll_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/summaryScroll.js */ "./src/js/components/summaryScroll.js");
...
(0,_components_smoothScroll__WEBPACK_IMPORTED_MODULE_6__["default"])();
(0,_components_summaryScroll_js__WEBPACK_IMPORTED_MODULE_7__["default"])();
})();
