...
const Component_ContactPopup = () => {
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const menuContactLink = document.querySelector("#menu-item-526.popup-trigger a");
...
const Slick = () => {
  ...
  jQuery(".slider--hero").slick({
    ...
    useTransform: false,
    autoplaySpeed: 2000,
    // Wechselt alle 2 Sekunden zum nächsten Slide
    speed: 300,
    // Übergangsgeschwindigkeit zwischen den Slides
    cssEase: "ease",
    // Sanfterer Übergang statt linear
    variableWidth: false,
    // Wichtig: false, damit die Slides einheitliche Breite haben
    slidesToShow: 1,
    // Nur ein Slide vollständig anzeigen
    slidesToScroll: 1,
    adaptiveHeight: false,
    centerMode: false,
    // Kein centerMode
    rtl: false,
    // Nicht rechts-nach-links
